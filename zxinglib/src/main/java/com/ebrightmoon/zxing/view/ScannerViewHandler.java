...
public final class ScannerViewHandler extends Handler {
    ...
    public ScannerViewHandler(ScannerOptions scannerOptions, CameraManager cameraManager
            , HandleDecodeListener handleDecodeListener,ViewfinderView viewfinderView) {
        ...
        decodeThread = new DecodeThread(cameraManager, this
                ...
                ,new ViewfinderResultPointCallback(viewfinderView) ,scannerOptions.isCreateQrThumbnail());
